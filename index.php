    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">+213792962223</a>
            </div>
            <div class="email">
              Email:
              <a href="ridabenattia36@gmailcom" class="email__addr">ridabenattia36@gmailcom</a>
            </div>
          </div>
      ...
      <div class="banners">
        <div class="container clearfix">
          ...
          <div class="banner-award">
            <span>Social Media</span><br> Links
          </div>

          <div class="banner-social">
            <a href="https://web.facebook.com/Rida.Child.Prince" class="banner-social__link">
            <i class="icon-facebook"></i>
          </a>
            <a href="#" class="banner-social__link">
            <i class="icon-twitter"></i>
          </a>
            <a href="https://www.instagram.com/rida_benattia/" class="banner-social__link">
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy;Memoir Fin D'etude 2022/2023 &trade;
          </div>

          <div class="developer">
            Developed by Ben Attia Reda
          </div>

          <div class="designby">
            Design by Barech Marouane Nouaim
          </div>
